...
Super.prototype.fillFormByLabel = function <T extends Record<string, boolean | string | string[]>>(data: T) {
  ...
  return this.evaluate(callback as unknown as EvaluateFuncWith<Element, [T]>, data) as any;
};
...
Super.prototype.number = function <T = HTMLElement>(
  ...
  return this.evaluate(callback as unknown as EvaluateFuncWith<Element, [string, any]>, decimal, property as any) as Promise<number[]>;
};

Super.prototype.selectByLabel = function (...values: string[]): Promise<string[]> {
  ...
  return this.evaluate(callback as unknown as EvaluateFuncWith<Element, unknown[]>, values) as Promise<string[]>;
};

Super.prototype.string = function <T = HTMLElement>(property: KeysOfType<T, string> = 'textContent' as any): Promise<string> {
  ...
  return this.evaluate(callback as unknown as EvaluateFuncWith<Element, [any]>, property as any) as Promise<string>;
};
